...
#undef  ERROR
#define ERROR(desc,...) LCError(LC_THIS_FILE, LC_THIS_METHOD, LC_THIS_LINE, desc, ##__VA_ARGS__) /* The ERROR is not affected by KD_DEBUG_ENABLE and could set the local filelogs. For example:LC 👿ERROR👿 ⥤ error warning! */
